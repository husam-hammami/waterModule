...
export function WaterQualityCharts() {
  ...
  return (
    <>
      {/* Water Quality Monitoring - Top Left with proper spacing */}
      <div className="absolute top-16 left-3 z-20 bg-slate-800/95 backdrop-blur-sm rounded-xl p-3 border border-blue-500/30 w-64">
      ...
      {/* Treatment Efficiency - Top Right with proper spacing */}
      <div className="absolute top-16 right-3 z-20 bg-slate-800/95 backdrop-blur-sm rounded-xl p-3 border border-emerald-500/30 w-64">
        <div className="flex items-center gap-2 mb-3">
      ...
      {/* Chemical Dosing - Bottom Left with proper spacing */}
      <div className="absolute bottom-16 left-3 z-20 bg-slate-800/95 backdrop-blur-sm rounded-xl p-4 border border-purple-500/30 w-72">
        <div className="flex items-center gap-2 mb-3">
      ...
      {/* Production Analytics - Bottom Right with proper spacing */}
      <div className="absolute bottom-16 right-3 z-20 bg-slate-800/95 backdrop-blur-sm rounded-xl p-4 border border-cyan-500/30 w-72">
        <div className="flex items-center gap-2 mb-3">
